# -*- coding: utf-8 -*-
"""
Mosaik interface for gas boiler model

"""

import mosaik_api
from models.gasboiler_model import GasBoiler
...
class Boilersimulator(mosaik_api.Simulator):
    ...
    def create(self, num, model, params):
        ...
        for i in range(next_eid, next_eid + num):
            ...
            self.models[eid] = GasBoiler(params)
    ...
    def get_data(self, outputs):
        ...
        for eid, attrs in outputs.items():
            data[eid] = {}
            for attr in attrs:
                if attr not in self.meta['models']['GasBoiler'][
                        'attrs']:
...
def main():
    return mosaik_api.start_simulation(Boilersimulator())
